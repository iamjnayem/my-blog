                ...
                <div className="flex-1 md:mr-8">
                    ...
                    <div className={`flex border-b ${darkMode ? 'border-gray-700 bg-gray-900' : 'border-green-200 bg-white'} mb-6 sticky top-19.5 z-10`}>
                        ...
                        <div className="relative ml-auto w-64 py-2">
                            <select
                                className={`px-4 py-2 rounded-lg w-full appearance-none shadow-sm bg-gradient-to-r ${darkMode ? 'from-gray-800 to-gray-900 text-gray-300 border-gray-700' : 'from-white to-gray-50 text-gray-800 border-gray-300'} border focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition duration-300`}
